        ...
        <div className='px-[100px]'>
          <div className='flex flex-row justify-between items-center pt-[100px]'>
            <div className='flex flex-col gap-5'>
              ...
              <div className='text-lg font-light text-white'>At cryptoX, it’s more than just buying/selling digital currencies - it’s about being a part of something bigger. We provide you with live coin tracking with currency exchanges.</div>
              <div className='flex flex-row gap-3' style={{marginBottom:"25px"}}>
